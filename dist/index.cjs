...
exports.allSubCounties = allSubCounties;
exports.counties = counties;
exports.countiesByRegion = countiesByRegion;
exports.detectNetwork = detectNetwork;
exports.findCounty = findCounty;
exports.findCountyByCode = findCountyByCode;
exports.findCountyByName = findCountyByName;
exports.findCountyBySlug = findCountyBySlug;
exports.findCountyBySubCounty = findCountyBySubCounty;
exports.formatKeId = formatKeId;
exports.formatKes = formatKes;
exports.formatKraPin = formatKraPin;
exports.formatPhone = formatPhone;
exports.isMaishaCardExpired = isMaishaCardExpired;
exports.isMpesaSms = isMpesaSms;
exports.isValidKeId = isValidKeId;
...
exports.parseKeId = parseKeId;
exports.parseKes = parseKes;
exports.parseKraPin = parseKraPin;
exports.parseMaishaCard = parseMaishaCard;
